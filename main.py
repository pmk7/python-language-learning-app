...
class BaseUser:
    ...
    def add_word(self, german, english):
      if self.find_word(german):
        ...
        word = {'id': word_id, 'german': german, 'english': english, 'correct': 0, 'incorrect': 0}
...
class Quiz:
  ...
  def random_word(self):
    ...
    if answer == random_word.get('english'):
      ...
      print("Would you like to add this word to your dictionary?")
      userInput = input("Press 'y' for yes and 'n' for no: ")
      if userInput == 'y':
        BaseUser.update_my_vocab(self, ger_word, random_word.get('english'))
        print("Word added!")
